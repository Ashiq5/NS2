...
#                            CHNG PATH		1		######################################################
ns /home/ashiq/Desktop/802_11_udp.tcl $r # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
#                            CHNG PATH		2		######################################################
awk -f /home/ashiq/Desktop/rule_wireless_udp.awk /home/ashiq/Desktop/multi_radio_802_11_random.tr > /home/ashiq/Desktop/multi_radio_802_11_random.out
