...
#set num_random_flow [lindex $argv 3]
#set num_nodes [lindex $argv 0]
set x_dim [lindex $argv 1] ;
set y_dim [lindex $argv 2] ;
...
set val(txpower_11) [expr 1679.4e-3*$t]			;#LEAP (802.11g)
...
set nm /home/ashiq/Desktop/1305070_ns2/multi_radio_802_11_random.nam
set tr /home/ashiq/Desktop/1305070_ns2/multi_radio_802_11_random.tr
set topo_file /home/ashiq/Desktop/1305070_ns2/topo_multi_radio_802_11_random.txt
